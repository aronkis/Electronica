...
% f1536 TX-ingress fix (TXMUX 2026-07-25): the f1536 path uses the STRICT
% shifter (start-beat wordFirst re-check -> bounded self-heal of any word-
% phase error). k5 keeps qpskByteBitShifter verbatim => k5 HDL byte-identical
% (G0). See qpskByteBitShifterStrict.m header for the silicon root cause.
cfg = frame_config_k5();
