// -------------------------------------------------------------
// 
// File Name: hdl_prj_jupiter_composite/hdlsrc/commhdlQPSKTxRxLoopback/Packet_Controller.v
...
// Source Path: commhdlQPSKTxRxLoopback/TxRxComposite/Receiver/QPSK Rx/Frequency and Time Synchronizer/Packet Controller
// Hierarchy Level: 4
...
module Packet_Controller
  ...
  MATLAB_Function_block u_MATLAB_Function (.clk(clk),
                                                            .reset(reset),
                                                            .enb_1_2_0(enb_1_2_0),
                                                            .valid(validIn),
                                                            .syncPulse(syncPulse),
  ...
  End_Generator u_End_Generator (.clk(clk),
                                                  .reset(reset),
                                                  .enb_1_2_0(enb_1_2_0),
                                                  .validIn(Delay1_out1),
  ...
  sample_discard_controller u_sample_discard_controller (.clk(clk),
                                                                          .reset(reset),
                                                                          .enb_1_2_0(enb_1_2_0),
