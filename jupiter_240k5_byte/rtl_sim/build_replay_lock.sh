...
#     jupiter_240k5_byte/s1_rtl ....... 8 lines (filename/timestamp/model 11.330 vs .331)
...
#
# CADENCE CONTRACT (two_jup/HARNESS_AB.md) -- getting this wrong yields 0 CRC-good and
