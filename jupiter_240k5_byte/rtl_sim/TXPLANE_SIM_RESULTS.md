...
- Netlist: `s1_rtl_beatfix3` (the flashed lineage per `NETLIST_PROVENANCE.md`; the probe images are that lineage) through `wrap_byte_bf2.v` (`wrap_byte_ce`, cadence 2, fixctl=0), internal loopback (`rx_input_select=0`), `tx_data_source=1`.
