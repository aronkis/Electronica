// wrap_byte.v -- Verilator wrapper for the jupiter_240k5_byte TxRxComposite
...
module fir_probe_wrap
  (input  wire clk, input wire reset,
   ...
   output wire railEnb,
   output wire repEnb,
   output wire signed [15:0] repInI, output wire signed [15:0] repOutI,
   output wire signed [15:0] repInQ, output wire signed [15:0] repOutQ);
  ...
  assign repEnb  = dut.enb;
  assign repInI  = dut.Transmitter_dataOutI;
  assign repOutI = dut.REP_TxI_out1;
  assign repInQ  = dut.Transmitter_dataOutQ;
  assign repOutQ = dut.REP_TxQ_out1;
endmodule
