...
module wrap_byte_lock
  ...
  assign ssErr  = dut.u_Receiver.u_QPSK_Rx.u_Frequency_and_Time_Synchronizer.u_Symbol_Synchronizer.Gardner_TED_e;
  assign ssIntP = dut.u_Receiver.u_QPSK_Rx.u_Frequency_and_Time_Synchronizer.u_Symbol_Synchronizer.Loop_Filter_stateP;
  assign ssIntI = dut.u_Receiver.u_QPSK_Rx.u_Frequency_and_Time_Synchronizer.u_Symbol_Synchronizer.Loop_Filter_stateI;
  assign csErr  = dut.u_Receiver.u_QPSK_Rx.u_Frequency_and_Time_Synchronizer.u_Carrier_Synchronizer.Phase_Error_Detector_PhaseError;
  assign csIntP = dut.u_Receiver.u_QPSK_Rx.u_Frequency_and_Time_Synchronizer.u_Carrier_Synchronizer.Loop_Filter_stateP;
  assign csIntI = dut.u_Receiver.u_QPSK_Rx.u_Frequency_and_Time_Synchronizer.u_Carrier_Synchronizer.Loop_Filter_stateI;
endmodule
