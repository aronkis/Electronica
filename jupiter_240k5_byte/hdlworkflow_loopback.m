...
% --- loop-gain tuning mappings (Task C3: runtime-writable Rx loop
%     constants; LEAN-only, reuse the canary 0x170-0x184 offsets which are
%     env-guarded off in LEAN). Block-existence guard self-syncs with the
%     loop_gain_axi_overlay gating. Inputs => AXI4-Lite WRITE registers. ---
if ~isempty(find_system('commhdlQPSKTxRxLoopback/TxRxComposite','SearchDepth',1,'BlockType','Inport','Name','cs_prop_gain'))
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/cs_prop_gain', 'IOInterface', 'AXI4-Lite');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/cs_prop_gain', 'IOInterfaceMapping', 'x"170"');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/cs_integ_gain', 'IOInterface', 'AXI4-Lite');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/cs_integ_gain', 'IOInterfaceMapping', 'x"174"');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/ss_prop_gain', 'IOInterface', 'AXI4-Lite');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/ss_prop_gain', 'IOInterfaceMapping', 'x"178"');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/ss_integ_gain', 'IOInterface', 'AXI4-Lite');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/ss_integ_gain', 'IOInterfaceMapping', 'x"17C"');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/agc_loop_gain', 'IOInterface', 'AXI4-Lite');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/agc_loop_gain', 'IOInterfaceMapping', 'x"180"');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/cfo_threshold', 'IOInterface', 'AXI4-Lite');
hdlset_param('commhdlQPSKTxRxLoopback/TxRxComposite/cfo_threshold', 'IOInterfaceMapping', 'x"184"');
end
% --- end loop-gain tuning mappings ---
