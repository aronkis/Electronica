 ...
 * README_hostlog.md ("Deploy" section; tag archive/pre-cleanup-2026-09-09)
 * -- ops/capture_r3.sh's scp list does not yet name it.
 */
#ifndef QPSK_JOIN_H
#define QPSK_JOIN_H
 ...
 * README_hostlog.md sections 2 and 3.3 (tag archive/pre-cleanup-2026-09-09). */
 ...
 * stream of 16 B "<QIHH" records; txlog_gaps.py (tag
 * archive/pre-cleanup-2026-09-09) and ops/loss_ledger.py:tx_gaps_146 still
 * assume that and must be updated).
 ...
 * join runs in Python (ops/comb/); this C helper is the executable spec
