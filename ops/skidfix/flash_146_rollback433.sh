...
A=10.0.0.146
RX=10.0.0.148
BB=$ROOT/jupiter_byte_tmr146_gates/boot/BOOT.BIN.146.433fd8da.bak
...
rollback(){
  ...
  wait_back || { echo "FLASH_146_FATAL: 146 not back after rollback -- PHYSICAL ATTENTION (backups: /root/BOOT.BIN.4be9286c.bak on 146 AND jupiter_byte_tmr146_gates/boot/BOOT.BIN.146.433fd8da.bak on nemo)"; exit 2; }
