...
FRESH=$ROOT/jupiter_byte_beatfix2_build
...
grep -q "BEATFIX_OVERLAY_OK v3" "$FRESH/build_byte_matlab.log" || { echo "BEATFIX_BUILD_FAILED: BEATFIX overlay never ran"; exit 1; }
