...
# run ops/skidfix/patch_seqbist_tcl.py on the kit's build_txfix.tcl -> widen
...
#
# Usage:  ops/skidfix/jupiter_byte_seqbist_kit.sh <148|146>
...
RTL_SRC="${RTL_SRC:-$REPO/modem/rtl_sim}"
...
PATCH_COMMIT=$(cd "$REPO" && git log -1 --format=%H -- ops/skidfix/patch_seqbist_tcl.py 2>/dev/null)
