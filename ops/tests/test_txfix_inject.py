"""Unit tests for ops/skidfix/txfix_inject.py (TXFIX T0a).
...
SRC = os.path.join(ROOT, 'modem/rtl_sim/s1_rtl_txmark/hdlsrc/commhdlQPSKTxRxLoopback')
sys.path.insert(0, os.path.join(ROOT, 'ops', 'skidfix'))
