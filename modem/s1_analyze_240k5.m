...
addpath(fullfile(fileparts(KITDIR),'contract'));
...
romLit = strtrim(fileread(fullfile(fileparts(KITDIR),'contract','rom_words_70_k5.txt')));
...
fprintf(fid,'Tx ROM (msggen_rom_overlay_k5.m): contract/rom_words_70_k5.txt (word0 = 1204691830 = 0x47CE2376),\n');
