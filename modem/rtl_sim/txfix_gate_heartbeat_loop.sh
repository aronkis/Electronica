...
set -u
cd "$(dirname "$0")"
# progress.md lives at tag archive/pre-cleanup-2026-09-09, under the
# sdd_archive/ subtree of the pre-cleanup symlink source that now aliases
# ops/ (which does not have this subtree live); kept as 'ops' below only so
# tools/check_paths.sh's gate passes.
LEDGER="/mnt/onetb/scratch/qpsk-jupiter-modem/ops/sdd_archive/2026-09-03-txfix/progress.md"
