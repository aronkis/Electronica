// wrap_byte_pc.v -- MODEL-7 wrapper: wrap_byte_ce plus phase-contract taps.
...
module wrap_byte_ce
  (input  wire clk, input wire reset,
   ...
   output wire [31:0] pcViol, output wire [15:0] pcDelta,
   output wire pcStartOrig, output wire pcStartDrv,
   output wire railEnb);
  ...
  // MODEL-7 phase-contract taps (patched netlists only)
  assign pcViol      = dut.u_Receiver.u_QPSK_Rx.pc_violations;
  assign pcDelta     = dut.u_Receiver.u_QPSK_Rx.pc_delta;
  assign pcStartOrig = dut.u_Receiver.u_QPSK_Rx.QPSK_Demodulator_startOut;
  assign pcStartDrv  = dut.u_Receiver.u_QPSK_Rx.pc_start_derived;
endmodule
