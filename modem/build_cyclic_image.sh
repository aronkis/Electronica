...
# byte-plane S2MM DMAC at 0x9D200000 -- see DMAC_IDENTIFIED.md (tag
# archive/pre-cleanup-2026-09-09); NOT
...
[ -n "${QPSK_FRAME:-}" ] && [ -n "${QPSK_SPS:-}" ] || {
  echo "FATAL: QPSK_FRAME and QPSK_SPS must be set explicitly (Image B: QPSK_FRAME=f1536 QPSK_SPS=4). See docs/measurement-discipline.rst."; exit 2; }
