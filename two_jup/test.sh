...
# docs/TESTING.md for the acceptance ladder and how to read each result.
#
# Tiers:
...
case "$SUB" in
  ...
  bist)
    ...
    echo " most meaningful during an active link/loopback arm -- see docs/TESTING.md)"
