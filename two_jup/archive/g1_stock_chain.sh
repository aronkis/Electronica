#!/bin/bash
LOG=/mnt/onetb/scratch/qpsk_variants/jupiter_240k5/build_t8stock_orchestrator.log
...
B=/mnt/onetb/scratch/qpsk_variants/jupiter_t8stock/hdl_prj_jupiter_composite/vivado_ip_prj/boot/BOOT.BIN
