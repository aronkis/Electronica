...
SIG_BLOCK = """
  ...
  // Reference latched at frame %d, past the acquisition transient.
  // ==================================================================
  reg  [31:0] ssig   [0:%d];
  reg  [31:0] ssigl  [0:%d];
  reg  [31:0] sref   [0:%d];
  ...
  assign sval[3] = 1'b1;
  assign sdat[4] = {Frequency_and_Time_Synchronizer_postCarrierSync_re, Frequency_and_Time_Synchronizer_postCarrierSync_im};
  assign sval[4] = 1'b1;
  assign sdat[5] = {QPSKConstellationPoints_re, QPSKConstellationPoints_im};
...
""" % (REFN, NTAP-1, NTAP-1, NTAP-1, NTAP-1, NTAP-1, NTAP-1,
       NTAP-1, NTAP-1, REFN, REFN, NTAP-1)
