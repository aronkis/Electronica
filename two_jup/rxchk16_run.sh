...
print(f"  TX starvation (this board's TX input): ep>1k={d.get('ep_gt1k',0)} >2k={d.get('ep_gt2k',0)} >3k={d.get('ep_gt3k',0)} >6k={d.get('ep_gt6k',0)} >12k={d.get('ep_gt12k',0)} >25k={d.get('ep_gt25k',0)} starve_clk={d.get('starve_clk',0)} max_len(cum)={kz.get('max_len',0)} clk")
