#!/usr/bin/env python3
"""two_jup/comb/common.py -- shared plumbing for the T0b comb analysis tools.
...
from frame_taxonomy import read_frames  # noqa: E402  (path insert above)
...
def loss_slot_trains(fr, settle_s=SETTLE_S):
    ...
    idx = np.flatnonzero(1 - pres)
    runs = _runs(idx)

    all_loss = (1 - pres).astype(np.int8)
