...
#
# Clones the session discipline of two_jup/capture_paired.sh / tap_smoke.sh:
...
#   -o outdir    output dir (default two_jup/evmcap/<ts>_<A|B>)
#
...
#
# Output: two_jup/evmcap/<ts>_<A|B>/
