...
## 2026-09-03 — TXFIX campaign pointer
Mechanism, fix variants (F1/F2/F3 in RTL terms), Vivado build history and silicon state: **two_jup/TXFIX_STATE.md** (kept current by the controller). Ledger: two_jup/sdd_archive/2026-09-03-txfix/progress.md. Sim gate: two_jup/TXFIX_SIM_GATE.md. Science chain: SESSION_20260830_AUTONOMOUS.md §87–§90.
