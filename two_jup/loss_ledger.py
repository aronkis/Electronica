...
2026-08-12 framelogs (two_jup/r3cap). Classifies EVERY hole in the clean-seq
ladder of each frames.bin into named classes and emits two_jup/LOSS_LEDGER.md
...
def main():
    ...
    A("every 2026-08-12 framelog under `two_jup/r3cap/` is classified below; the")
    A("unnamed bucket is enumerated event-by-event at the end. Generated by")
    A("`two_jup/loss_ledger.py` (this file is its output; re-run to regenerate).")
    A("")
