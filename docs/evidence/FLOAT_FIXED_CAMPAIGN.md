> Evidence ledger, moved verbatim from `two_jup/FLOAT_FIXED_CAMPAIGN.md` on 2026-09-09. Relative paths inside refer to the tree at tag `archive/pre-cleanup-2026-09-09`.
