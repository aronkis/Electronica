> Evidence ledger, moved verbatim from `two_jup/comb/DTREF_CENSUS_CONTROLS.md` on 2026-09-09. Relative paths inside refer to the tree at tag `archive/pre-cleanup-2026-09-09`.
