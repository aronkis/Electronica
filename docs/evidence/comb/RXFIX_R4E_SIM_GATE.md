> Evidence ledger, moved verbatim from `two_jup/comb/RXFIX_R4E_SIM_GATE.md` on 2026-09-09. Relative paths inside refer to the tree at tag `archive/pre-cleanup-2026-09-09`.
